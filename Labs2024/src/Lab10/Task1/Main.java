...
public class Main {
    public static void main(String[] args) {
        ...
        while (visited.size() < N) {
            ...
            // For each visited city
            for (String city : visited) {
                // Get all its neighbors and their distances
                Map<String, Integer> neighbors = graph.getNeighbors(city);

                // Check each neighbor
                for (Map.Entry<String, Integer> neighbor : neighbors.entrySet()) {
                    String destination = neighbor.getKey();
                    int cost = neighbor.getValue();

                    // If this neighbor hasn't been visited and has a lower cost
                    if (!visited.contains(destination) && cost < minCost) {
                        minCost = cost;
            ...
            // Add the next city to visited set and add its cost to total
