...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            SLLNode<MapEntry<String, Person>> earliestPerson = earliest.search(person.city);


            if (ci == null) {
                if (hours == 11 && minutes > 45) {
                    count.insert(person.city, 1);
                    earliest.insert(person.city, person);
                } else if (hours > 11) {
                    count.insert(person.city, 1);
                    earliest.insert(person.city, person);
                }
                ...
                if (hours == 11 && minutes > 45) {
                    count.insert(person.city, ci.element.value + 1);
        ...
        for (int i = 0; i < M; i++) {
            ...
            SLLNode<MapEntry<String, Person>> nodeEarliest = earliest.search(person.city);
