    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < N + Q; i++) {
            ...
            if (what.equals("root")) {
                ...
                System.out.println(countDegrees(nodeCurrent));
            }
        }
    }

    private static int countDegrees(BNode<String> node) {
        if (node == null) {
            return 0;
        }
        ...
        int count = 0;
        if (node.left != null) {
            count += 1 + countDegrees(node.left);
        }
        if (node.right != null) {
            count += 1 + countDegrees(node.right);
        }
