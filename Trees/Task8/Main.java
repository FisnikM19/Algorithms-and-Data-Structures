    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < N + Q; i++) {
            ...
            if (what.equals("insert")) {
                ...
                System.out.println(findBiggerElements(root, node));

            }
        }
    }

    private static int findBiggerElements(BNode<Integer> root, BNode<Integer> node) {
        if (root == null) {
            return 0;
        }
        int count = 0;
        ...
        count += findBiggerElements(root.left, node);
        count += findBiggerElements(root.right, node);
