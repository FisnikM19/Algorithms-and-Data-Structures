    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < N + Q; i++) {
            ...
            if (what.equals("insert")) {
                ...
                System.out.println(findDepth(elem, root));

            }
        }
    }

    private static int findDepth(int elem, BNode<Integer> root) {
        if (root == null) {
            return 0;
        }
        ...
        if (root.info > elem) {
            depth += 1 + findDepth(elem, root.left);
        }
        if (root.info < elem) {
            depth += 1 + findDepth(elem, root.right);
        }
