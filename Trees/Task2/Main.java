    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < N + Q; i++) {
            ...
            if (what.equals("root")) {
                ...
                System.out.println(countInternalNodes(nodeCurrent));
            }
        }
    }

    private static int countInternalNodes(BNode<String> node) {
        if (node == null) {
            return 0;
        }
        ...
        total += countInternalNodes(node.left);
        total += countInternalNodes(node.right);
