...
// A double linked list of double linked lists is given. Find the sum of each sub-list, and then
// the product of all those sums.
// Input: Integer N that tells us how many lists there are. Integer M that tells us how many
// elements there are in each list.
...
public class Task2 {
    ...
    public static long findMagicNumber(DLL<DLL<Integer>> list) {
        ...
        while (outerNode != null) {
            DLL<Integer> innerList = outerNode.element;
            DLLNode<Integer> innerNode = innerList.getFirst();
            int sum = 0;
