package AdditionalPracticeTasks.Task4;
...
public class NodeDistance {
    ...
    private static int minDistance(String from, String to, BTree<String> tree) {
    ...
    private static int getLevel(String val, BNode<String> node, int level) {
        if (node == null) {
            return -1;
        }
    ...
    private static BNode<String> closestAncestor(String from, String to, BNode<String> root) {
        if (root == null) {
            return null;
        }
        ...
        BNode<String> tmp1 = closestAncestor(from, to, root.left);
        BNode<String> tmp2 = closestAncestor(from, to, root.right);
